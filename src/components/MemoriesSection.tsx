...
const memories: Memory[] = [
  { caption: "you laughed too hard here", src: "/photo/Photo1.webp", hue: "from-pink-300/40 to-purple-400/30", top: 2, left: 8, width: 170, rotate: -7, hidden: "prittiest💗🌹!!!" },
  ...
  { caption: "our favourite evening", src: "/photo/Photo3.webp", hue: "from-amber-200/40 to-pink-300/30", top: 38, left: 12, width: 180, rotate: 4, hidden: "gods plan;lovely gola✨️" },
